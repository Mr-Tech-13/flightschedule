...
import { pool, id, migrate, tx, createDatabaseBackup, closeDatabase } from './db.js';
...
const port=Number(process.env.PORT||3000),host=process.env.HOST||'0.0.0.0';const server=app.listen(port,host,()=>console.log(`FlightDeck listening on http://${host}:${port}`));
